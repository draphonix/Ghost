...
const Twitter: React.FC<{ keywords: string[] }> = ({ keywords }) => {
    ...
    const inputFields = (
        <div className="flex flex-col gap-3 md:flex-row">
            ...
            <div className="w-full md:mr-[52px]">
                <div className="mb-2">
                    <span className="mr-1 font-semibold text-grey-900 dark:text-grey-300">
                        {siteTitle}
                    </span>
    ...
    return (
        <TopLevelGroup
            description="Tuỳ chọn hiển thị khi liên kết của bạn được chia sẻ trên X (Twitter)"
            isEditing={isEditing}
            keywords={keywords}
            navid="twitter"
            saveState={saveState}
...
export default withErrorBoundary(Twitter, "Thẻ Twitter");
