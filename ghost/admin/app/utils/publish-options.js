...
export default class PublishOptions {
    ...
    get emailUnavailable() {
        return (
            this.post.isPage || this.post.email || this.emailDisabledInSettings
        );
    }
    ...
    get emailDisabled() {
        ...
        return (
            !this.mailgunIsConfigured || hasNoMembers || this.emailDisabledError
        );
    }

    get mailgunIsConfigured() {
        return (
            this.settings.mailgunIsConfigured || this.config.mailgunIsConfigured
        );
    }
    ...
    *revertToDraftTask() {
    ...
    _applyModelChanges() {
        ...
        const revertableModelProperties = [
            "status",
            "publishedAtUTC",
            "emailOnly",
        ];
